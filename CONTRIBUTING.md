...
- [`.agent/rules/architecture.md`](.agent/rules/architecture.md) — crate structure, encryption model, backup/restore pipelines, where code belongs
- [`.agent/rules/contributing.md`](.agent/rules/contributing.md) — layer boundaries, naming conventions, testing patterns, DRY rules
- [`.agent/rules/threat-model.md`](.agent/rules/threat-model.md) — trust boundaries and security invariants that must never be weakened
...
- List any invariants your change preserves or touches (device isolation, idempotency, encryption ordering — see [`.agent/rules/threat-model.md`](.agent/rules/threat-model.md)).
